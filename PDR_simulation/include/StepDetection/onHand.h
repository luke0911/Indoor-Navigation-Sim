...
public:
    ...
    PDR getStatus() const;
    double getLastRawGlobalX() const { return lastRawGlobalX_; }
    double getLastRawGlobalY() const { return lastRawGlobalY_; }
    ...
    double getLastStepPeakToPeak() const { return lastStepPeakToPeak_; }
...
private:
    ...
    double lastRawGlobalX_ = 0.0;
    double lastRawGlobalY_ = 0.0;
    double lastRawGlobalZ_ = 0.0;
    double maxHorizontalAcc = 0.0;  // 스텝 구간 내 수평 가속도 최댓값
    double lastPeakZ_ = 0.0;
    double lastValleyZ_ = 0.0;
    double lastStepPeakToPeak_ = 0.0;
